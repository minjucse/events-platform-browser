          ...
          <div className="relative pt-16 pb-6 px-6">
            <div className="flex flex-col sm:flex-row gap-6 items-start sm:items-end">
              ...
              <div className="flex gap-2 w-full sm:w-auto">
                <Link href="/dashboard/profile/edit" className="flex-1 sm:flex-none">
                  <Button
                    variant="outline"
              ...
              <div className="space-y-6">
                ...
                <div>
                  ...
                  <div className="space-y-2 text-sm text-muted-foreground">
                    ...
                    {(currentUser.address || currentUser.location) && (
                      <p>Location: {currentUser.address || currentUser.location}</p>
                    )}
                  </div>
                </div>
              </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  ...
                  {currentUser.gender && (
                    <div>
                      ...
                      <p className="text-muted-foreground capitalize">{currentUser.gender.toLowerCase()}</p>
                    </div>
                  )}
                  ...
                  <div>
                    ...
                    <Badge variant={currentUser.isEmailVerified ? "default" : "secondary"}>
